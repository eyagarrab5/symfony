            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="http://localhost/forum/view/afficher.php">Back to interface</a>
                            <a class="nav-link menu-link" href="#sidebarDashboards1" data-bs-toggle="collapse" role="button"
                               aria-expanded="false" aria-controls="sidebarDashboards1">
                                <i class="ri-notification-2-line"></i> <span data-key="t-dashboards">Forum</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarDashboards1">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="afficherab.php" class="nav-link" data-key="t-crm">Display Post</a>
                                    </li>
